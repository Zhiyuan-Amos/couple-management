...
public static class EventAdapter
{
    ...
    public static EventViewModel ToViewModel(EventModel model) => new(model.Id, model.Title, model.Start, model.End,
        new(model.ToDos));
    ...
    public static List<TaskDto> ToTaskDto(IEnumerable<TaskModel> models) => models.Select(ToTaskDto).ToList();
